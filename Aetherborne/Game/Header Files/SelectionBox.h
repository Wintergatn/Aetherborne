...
public:
    SelectionBox(Aetherborne::Engine& engine, Aetherborne::CameraSystem& cameraSystem);

    Aetherborne::Image& image() { return *m_image; }
    ...
    void transfer(Aetherborne::TransferNode& transferNode);
    void createPipeline(vk::RenderPass& renderPass);
    void createMesh(Aetherborne::TransferNode& transferNode, MeshManager& meshManager);
...
private:
    ...
    std::unique_ptr<Aetherborne::Mesh> m_mesh;
    std::unique_ptr<Aetherborne::Image> m_image;
