...
entt::entity World::createChunk(glm::ivec3 worldChunkPos) {
    ...
    if (m_recycleQueue.size() > 0) {
        ...
        //std::vector<entt::entity> testVec;
        //testVec.push_back(chunkEntity);
        //testVec.push_back(chunkEntity);
        m_registry.emplace<Chunk>(chunkEntity, chunkEntity, worldChunkPos, *this);
        //m.assign<Chunk>(chunkEntity, chunkEntity, worldChunkPos, *this);
        //m_registry.assign<Chunk>(testVec.begin(), testVec.end());
    }
